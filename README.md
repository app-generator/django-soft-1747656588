...
- Get [Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-soft-1747656588) via `eMail` and `Discord`
- Resources:
...
```bash
$ git clone https://github.com/django-soft-1747656588.git
$ cd django-soft-1747656588
```
